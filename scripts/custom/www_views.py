...
class ConnectionModelView(wwwutils.SuperUserMixin, AirflowModelView):
    ...
    form_columns = (
        ...
        'extra__grpc__scopes',
        'extra__oci__fingerprint',
        'extra__oci__key_file',
        'extra__oci__tenancy',
        'extra__oci__region',
    ...
    form_extra_fields = {
        ...
        'extra__oci__fingerprint': StringField('API Key Fingerprint'),
        'extra__oci__key_file': StringField('API Key Path'),
        'extra__oci__tenancy': StringField('Tenancy OCID'),
        'extra__oci__region': StringField('OCI Region'),
    ...
    def on_model_change(self, form, model, is_created):
        formdata = form.data
        if formdata['conn_type'] in ['jdbc', 'google_cloud_platform', 'gprc', 'oci', 'yandexcloud']:
            extra = {
                key: formdata[key]
